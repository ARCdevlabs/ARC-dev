            ...
            TransactionGroup trangroup = new TransactionGroup(doc, "Input Beam Insulation Group Trans");
            {
                ...
                try
                {
                    ...
                    foreach (Element ele in listElement)
                    {
                        ...
                        //int categoryBuiltinId = (int)(BuiltInCategory.OST_StructuralFraming);
                        ...
                        {    
                            ...
                            Element beamType = doc.GetElement(new ElementId(13042529)); //Cần điều chỉnh lại beamTypeSymbol dựa vào form WPF
