        ...
        try:
            ...
            if from_pattern:
                ...
                # otherwise use a simple find/replacer
                    ...
                    ''' Xác định tên family'''
                    check = find_type_by_family_and_type_name(doc,"MK_梁〈RC〉_Glass", str(self.newvalue))
    ...
    def apply_new_values(self, sender, args):
        ...
        for item,tung_element in zip(self._revalue_items,self._target_elements):
            try:
                ...
                xac_dinh_type = find_type_by_family_and_type_name(doc,"MK_梁〈RC〉_Glass", str(type_name))
